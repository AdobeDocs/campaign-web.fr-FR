...
>[!AVAILABILITY]
>
>* L’[historique et les journaux](../../v8/workflows/start-monitor-workflows.md#logs-tasks) d’exécution des workflows sont disponibles dans Adobe Campaign v8.
>
>* Les journaux historiques des workflows exécutés sur votre instance de Campaign Standard ne sont pas migrés vers Campaign v8.
>
...
1. **Concevoir et définir du contenu**
   ...
   Pour un processus de conception accéléré et amélioré, vous pouvez créer des modèles autonomes pour réutiliser facilement le contenu personnalisé dans Adobe Campaign. Voir [Créer des modèles d’e-mail](../../v8/email/create-email-templates.md)
