...
1. Développez la section **[!UICONTROL Format d’extraction]** pour accéder aux options spécifiques du fichier d’extraction. Les valeurs disponibles dépendent du format sélectionné.
   ...
   * **[!UICONTROL Encodage]** : choisissez l’encodage du fichier d’extraction. L’encodage par défaut est **Latin-1 (1252)**. Lors de la création de diffusions de publipostage direct ciblant des destinataires dans les langues CJC (japonais, coréen, chinois simplifié, chinois traditionnel), sélectionnez **UTF-8 (65001)** à la place. Latin-1 ne peut pas représenter les caractères CJC et entraînera l’affichage d’un aperçu de fichier vide.
