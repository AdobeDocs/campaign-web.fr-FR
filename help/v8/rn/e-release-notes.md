...
**Les notes de mise à jour anticipées ci-dessous peuvent être modifiées sans préavis jusqu’à la date de publication.**. Les liens, écrans et la documentation mise à jour sont publiés dans les [notes de mise à jour](release-notes.md) à la date de publication.
...
<tr>
<td>
<p>Vous pouvez désormais créer des typologies et des règles de typologie dans l’interface d’utilisation web d’Adobe Campaign. Les typologies permettent de contrôler, de filtrer et de hiérarchiser l’envoi des diffusions. Les typologies valident le fait que les diffusions contiennent toujours des composants obligatoires (tels qu’un lien de désinscription ou une ligne d’objet) ou des règles de filtrage pour exclure des groupes de votre audience (tels que les désabonnés, les concurrents ou les clients non fidèles).</p>
<img src="assets/do-not-localize/typology.gif" alt="Démonstration de la création de règles de typologie dans l’interface utilisateur web d’Adobe Campaign">
