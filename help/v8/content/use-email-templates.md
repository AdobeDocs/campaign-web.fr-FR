...
1. Ouvrez le [concepteur d’e-mail](../email/create-email-content.md).
...
1. La liste de tous les [modèles enregistrés](create-email-templates.md#save-as-template) s’affiche. Vous pouvez les trier **[!UICONTROL Par nom]**, selon la **[!UICONTROL Dernière modification]** et la **[!UICONTROL Dernière création]**.
...
1. Modifiez le contenu selon vos besoins à l’aide du concepteur d’e-mail. [En savoir plus](../email/create-email-content.md)