...
description: Découvrir comment générer des expériences de contenu textuel à l’aide de l’IA
...
Utilisez l’IA dans Adobe Campaign Web pour générer un texte attrayant qui trouve un écho auprès de votre audience. Que vous souhaitiez améliorer le contenu de vos e-mails, créer un contenu de page de destination convaincant, rédiger des messages de notification push ou composer des SMS, l’IA vous aide à transmettre un message clair et percutant.

## Pour les e-mails et les pages de destination {#email-web-channels}

Utilisez l’IA pour générer du contenu textuel de haute qualité pour vos diffusions d’e-mails et vos pages de destination. Cette fonctionnalité vous permet de créer des messages attrayants et conformes à votre marque, qui résonnent auprès de votre audience sur l’ensemble des points de contact numériques.

### Accéder et configurer {#access-configure}

Avant de pouvoir commencer à générer du contenu textuel avec l’IA, vous devrez configurer votre système de diffusion et accéder à l’éditeur de contenu. Pour préparer votre espace de travail et ouvrir le panneau Générer du contenu, procédez comme suit :
...
1. Sélectionnez un **[!UICONTROL composant de texte]** pour cibler du contenu spécifique, puis accédez au menu **[!UICONTROL Générer du contenu]**.
...
Découvrez comment créer des prompts clairs, affiner les paramètres et générer du texte personnalisé à l’aide de l’IA, en veillant à ce que vos messages s’alignent sur votre marque et vos objectifs de communication.
...
Utilisez l’IA pour générer un contenu textuel percutant pour vos notifications push et vos SMS, afin de créer des communications mobiles attrayantes qui touchent votre audience sur l’ensemble des points de contact mobiles.

### Accéder et configurer {#mobile-access-configure}

Avant de commencer à générer du texte avec l’IA pour les canaux mobiles, vous devez configurer votre diffusion et accéder à l’option Générer du contenu.
...
1. Accédez au menu **[!UICONTROL Afficher Générer du contenu]**.
   ...
   ![Copie d’écran affichant le menu Afficher Générer du contenu](assets/sms-genai-1.png){zoomable="yes"}
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Prompt]**.
   ...
   ![Générer du contenu avec le champ et les options de prompt](assets/sms-genai-2.png){zoomable="yes"}
...
1. Adaptez votre prompt avec les options **[!UICONTROL Paramètres de texte]** :
   ...
   * **[!UICONTROL Stratégie de communication]** : choisissez le style de communication le plus adapté au texte généré.
   * **[!UICONTROL Langues]** : sélectionnez la langue du contenu généré.
   * **[!UICONTROL Ton]** : le ton doit trouver écho auprès de votre audience. Que vous souhaitiez communiquer de façon informative, ludique ou convaincante, l’IA peut adapter le message en conséquence.
