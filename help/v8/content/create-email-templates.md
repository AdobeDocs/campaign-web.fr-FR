...
>abstract="Définissez facilement les propriétés de votre modèle de contenu d’e-mail pour le récupérer facilement, le cas échéant."
...
1. Cliquez sur **[!UICONTROL Créer]** et choisissez votre méthode de conception de modèle parmi les différentes options suivantes :
   ...
   * [Concevez votre contenu à partir de zéro](../email/create-email-content.md) dans l’interface du Concepteur d’e-mail.
   * [Codez ou collez du code HTML brut](../email/code-content.md) directement dans le Concepteur d’e-mail.
   ...
   * Utilisez du contenu existant à partir d’une liste de modèles intégrés ou personnalisés. Les étapes d’utilisation d’un modèle de contenu dans un e-mail sont décrites dans [cette section](use-email-templates.md).
   ...
   ![Options du Concepteur d’e-mail pour la création de modèles](assets/email_designer-templates.png){zoomable="yes"}

1. Le Concepteur d’e-mail s’affiche. Modifiez votre contenu selon vos besoins, comme vous le feriez pour n’importe quel e-mail, en fonction de l’option que vous avez sélectionnée. Découvrez comment utiliser le Concepteur d’e-mail dans [cette section](../email/get-started-email-designer.md).
...
Une fois votre [e-mail conçu](../email/create-email-content.md), vous pouvez enregistrer ce contenu en tant que modèle pour une réutilisation ultérieure. Les modèles enregistrés sont disponibles pour tous les utilisateurs et utilisatrices de votre environnement Adobe Campaign.
...
![Modèle enregistré dans le Concepteur d’e-mail](assets/email_designer-saved-template.png){zoomable="yes"}
...
1. Cliquez sur le bouton **[!UICONTROL Modifier le contenu]** pour mettre à jour votre contenu avec le [Concepteur d’e-mail](../email/get-started-email-designer.md).
...
* Directement dans le modèle de contenu, cliquez sur le bouton **Plus**, puis sélectionnez **Supprimer**.
...
* Directement dans le modèle de contenu, cliquez sur le bouton **Plus**, puis sélectionnez **Dupliquer**.
