...
>[!TAB Version de mars 2026]

La version de mars est en ligne. De nouvelles fonctionnalités et améliorations sont désormais disponibles dans l’interface d’utilisation  web de Campaign. Les points forts sont les suivants :

* **Création de schémas (GA)** - Créez et gérez des schémas directement dans l’UI web de Campaign.
* **Thèmes dans le Concepteur d’e-mail (LA)** - Appliquez des styles et des variables de thème réutilisables pour que le contenu des e-mails reste cohérent avec votre marque.
* **Améliorations apportées aux workflows** - Les activités **Diffusion automatisée** et **Démarrer** sont désormais disponibles et l’option **Jointure** prend désormais en charge l’option OR. Vous pouvez désormais également ajouter plusieurs branches à vos workflows.

Pour une vue d’ensemble complète, consultez les notes de mise à jour.

[![Bouton En savoir plus](assets/do-not-localize/learn-more-button.svg)](../v8/rn/release-notes.md)


>[!TAB Générer du contenu]

✨ Plongez dans une expérience pratique avec la prévisualisation de notre fonctionnalité en direct [Générer du contenu](../v8/content/generative-gs.md), conçue pour explorer ses capacités en avant-première et comprendre pleinement ses possibilités.
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <br/>
      <strong>Commencer</strong><br/><a href="get-started/get-started.md#web">Interface d’utilisation</a> - <a href="get-started/connect-to-campaign.md">Se connecter à Campaign</a> - <a href="get-started/permissions.md">Accès et autorisations</a>
    </td>
    <td>
      <img src="assets/do-not-localize/icon-experience.svg" width="35px">
    <br/>
      <strong>Expérience du client ou de la cliente</strong><br/><a href="workflows/gs-workflows.md" target="_blank">Automatiser avec des workflows</a> - <a href="campaigns/gs-campaigns.md" target="_blank">Orchestration de campagne</a> - <a href="personalization/gs-personalization.md">Contenu dynamique</a> - <a href="reporting/gs-reports.md">Rapports et analyse</a>
    </td>
    <td>
