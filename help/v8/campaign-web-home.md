...
>[!TAB Version du 26 mars]

La version de mars est en ligne. De nouvelles fonctionnalités et améliorations sont désormais disponibles dans l’interface utilisateur web de Campaign. Les points forts sont les suivants :

* **Création de schémas (GA)** - Créez et gérez des schémas directement dans l’interface utilisateur web de Campaign.
* **Thèmes dans Email Designer (LA)** - Appliquez des styles et des variables de thème réutilisables pour que le contenu des e-mails reste cohérent avec votre marque.
* **Améliorations apportées aux workflows** - Les activités **Diffusion automatisée** et **Démarrer** sont désormais disponibles et l’option **Joindre** prend désormais en charge l’option OU . Vous pouvez désormais également ajouter plusieurs branches à vos workflows.
