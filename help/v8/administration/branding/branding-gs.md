...
1. **Vérifier les instructions relatives à la délivrabilité** : avant de commencer à utiliser le nouveau domaine, la stratégie doit être discutée avec l’équipe Adobe chargée de la délivrabilité. Elle permettra de définir les bonnes pratiques, par exemple si une nouvelle affinité doit être créée pour partager les adresses IP entre les domaines, et/ou si un plan de déploiement doit être défini.
...
![Copie d’écran montrant la création de la marque.](assets/branding-legacy.png)
