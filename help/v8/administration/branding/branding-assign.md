...
1. Vous pouvez également ajouter des informations sur la marque à l’aide des champs de personnalisation. Accédez à **[!UICONTROL Branding]** et sélectionnez les blocs de personnalisation de marque que vous souhaitez insérer (tels que le nom de la marque, l’URL du logo, l’URL du site web, les informations sur l’expéditeur ou l’expéditrice, etc.).
