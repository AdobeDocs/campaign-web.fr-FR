...
description: Découvrez comment créer une diffusion WhatsApp dans l’interface utilisateur web d’Adobe Campaign
feature: Whatsapp
...
| Image d’en-tête | Image facultative qui s’affiche au-dessus du corps de votre message. |
...
Dans l’interface utilisateur web d’Adobe Campaign, procédez comme suit pour créer une diffusion WhatsApp autonome.

1. Accédez au menu **[!UICONTROL Diffusions]**, puis cliquez sur **[!UICONTROL Créer une diffusion]**.
...
1. Cliquez sur **[!UICONTROL Paramètres]** pour afficher les options avancées liées à votre modèle. [En savoir plus](../advanced-settings/delivery-settings.md)

   ![](assets/whatsapp-create-3.png)

1. Saisissez le **[!UICONTROL libellé]** de la diffusion. Utilisez **[!UICONTROL Options supplémentaires]** si vous avez besoin d’un nom interne, d’un dossier, d’un code de diffusion, d’une description ou d’une nature, du même modèle que les autres canaux.
...
1. Vous pouvez activer l’option **[!UICONTROL Activer la planification]** pour envoyer à une date et une heure spécifiques. [En savoir plus](../msg/gs-deliveries.md#gs-schedule).
...
Avant de concevoir votre message WhatsApp dans l&#39;interface utilisateur d&#39;Adobe Campaign Web, créez et envoyez votre modèle dans Meta. [En savoir plus](https://www.facebook.com/business/help/2055875911147364?id=2129163877102343)
...
1. Sur la page de configuration de la diffusion dans l’interface utilisateur web d’Adobe Campaign, cliquez sur **[!UICONTROL Modifier le contenu]** pour configurer le message WhatsApp.
...
1. Si votre modèle approuvé par Meta comprend une image, fournissez l’URL **[!UICONTROL Image]**.

   ![](assets/whatsapp-design-3.png)

1. Dans le champ **Espace réservé**, utilisez l’éditeur de personnalisation pour mapper les champs et expressions de profil aux paramètres du modèle. [En savoir plus](../personalization/personalize.md).
