...
![Capture d’écran montrant la page d’accueil avec des cartes des fonctionnalités et des options de navigation](assets/home.png){zoomable="yes"}
...
![Capture d’écran montrant le lien À propos au bas de la page](assets/about-link.png){zoomable="yes"}
...
![Capture d’écran montrant la section Packages installés avec la fonctionnalité de recherche](assets/about.png){zoomable="yes"}
