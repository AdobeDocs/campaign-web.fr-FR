---
title: Utilisation de l’aide contextuelle optimisée par l’IA dans Campaign Web
...
# Utilisation de l’aide contextuelle optimisée par l’IA {#using-ai}

Obtenez des réponses rapides et générées par l’IA en fonction de la documentation du produit et du contexte actuel du produit, avec l’aide contextuelle optimisée par l’IA et Q&amp;A disponible dans les boîtes d’aide contextuelle du produit.

>[!CAUTION]
>
>Cette fonctionnalité est disponible dans sa version Alpha et peut être modifiée sans préavis.
>
>Cette fonctionnalité n’est disponible qu’en **anglais**. Les autres langues ne sont pas prises en charge dans cette version.
...
Grâce aux fonctionnalités de Campaign Gen AI, ce composant transforme votre expérience, rendant la récupération d’informations et la résolution de problèmes plus facile. Que vous recherchiez des conseils dans une tâche complexe ou que vous naviguiez dans des documents complets, l’aide contextuelle optimisée par l’IA est votre compagnon ultime, offrant une efficacité et une précision inégalées dans chaque interaction.
...
L’aide contextuelle optimisée par Adobe Campaign AI offre de l’aide, mais vous devez vérifier les faits. Il peut produire des informations incorrectes ou des réponses inexactes ou trompeuses. Vérifiez la documentation du produit fournie sous forme de lien dans chaque zone d’aide.

L’intelligence artificielle et les modèles de machine learning s’améliorent au fil du temps pour mieux traiter des cas d’utilisation spécifiques. L’aide contextuelle optimisée par Campaign AI continuera à s’améliorer dans les prochains mois. Nous vous conseillons vivement d’utiliser les boutons ?? ?? à chaque fois que vous lisez une réponse, pour signaler toute réponse inappropriée à nos ingénieures et ingénieurs.

## Recommandations  {#recommendations-ai}

Lorsque vous posez une question dans l’aide contextuelle optimisée par l’IA, le contexte actuel du produit, c’est-à-dire l’écran dans lequel vous vous trouvez, et le contenu de la zone d’aide actuelle, sont pris en compte.
...
En outre, pour tirer le meilleur parti de l’aide contextuelle optimisée par l’IA, lorsque vous posez une question, nous vous conseillons de :
