---
title: Utiliser l’assistant de connaissances optimisé par l’IA dans Campaign Web
description: Utiliser l’assistant de connaissances optimisé par l’IA dans Campaign Web
badge: label="Alpha"
...
# Utiliser l’assistant de connaissances optimisé par l’IA {#using-ai}
...
L’**assistant de connaissances avec l’IA générative** incorporé dans l’aide contextuelle révolutionne la recherche de documentation et la réponse aux questions pratiques en analysant facilement de vastes référentiels de documentation grâce à l’identification instantanée des informations précises dont vous avez besoin.

Grâce aux fonctionnalités de l’IA générative de Campaign, cet assistant transforme votre expérience, en facilitant la récupération d’informations et la résolution de problèmes. Que vous soyez à la recherche de conseils dans une tâche complexe ou que vous parcouriez des documents volumineux, l’assistant de connaissances avec l’IA est votre meilleur compagnon, offrant une efficacité et une précision inégalées à chaque interaction.
...
L’assistant de connaissances optimisé par l’IA d’Adobe Campaign vous apporte de l’aide, mais vous devez vérifier les faits. Il peut produire des informations incorrectes ou des réponses inexactes ou trompeuses. Vérifiez la documentation du produit fournie sous forme de lien dans chaque zone d’aide.

L’intelligence artificielle et les modèles de machine learning s’améliorent au fil du temps pour mieux traiter des cas d’utilisation spécifiques. L’assistant de connaissances optimisé par l’IA de Campaign continuera de s’améliorer au cours des prochains mois. Nous vous conseillons vivement d’utiliser les boutons ?? ?? à chaque fois que vous lisez une réponse, pour signaler toute réponse inappropriée à nos ingénieures et ingénieurs.
...
En outre, pour tirer le meilleur parti de l’assistant de connaissances optimisé par l’IA, nous vous conseillons ce qui suit :
