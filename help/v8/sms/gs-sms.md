...
![](../assets/do-not-localize/book.png) Découvrez comment configurer le canal SMS dans cette [page](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaigns/send/sms.html?lang=en).
