...
La **Vue d’ensemble de la diffusion SMS** offre un résumé complet de votre diffusion SMS, avec des informations détaillées et des données spécifiques. Elle fournit des informations exhaustives sur les performances, l’efficacité et les résultats de chaque diffusion.
...
+++En savoir plus sur les mesures de rapports de diffusion SMS.
...
Ce rapport fournit des informations détaillées sur le débit des diffusions au cours d’une période spécifiée. La mesure principale utilisée pour mesurer la vitesse de diffusion des messages est le nombre de messages envoyés par heure.
