...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant l’interface de la bibliothèque d’invites.](assets/lp_full_gen_2.png){zoomable="yes"}
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant l’interface de la bibliothèque d’invites.](assets/lp-text-genai-2.png){zoomable="yes"}
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant l’interface de la bibliothèque d’invites.](assets/lp-image-gen-2.png){zoomable="yes"}
