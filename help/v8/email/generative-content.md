...
Une fois vos e-mails créés et personnalisés, utilisez l’assistant d’IA dans Adobe Campaign Web pour améliorer votre contenu.

L’assistant d’IA d’Adobe Campaign Web permet d’optimiser l’impact de vos diffusions en générant des e-mails complets, du contenu textuel ciblé et des images adaptés pour résonner auprès de votre audience. Vos campagnes par e-mail sont ainsi améliorées pour un meilleur engagement.

Avec vos campagnes par e-mail, utilisez l’assistant AI pour générer des e-mails, du texte ou des images complets. Explorez les onglets ci-dessous pour savoir comment utiliser l’assistant IA dans Adobe Campaign Web.
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant la bibliothèque d’invites dans Adobe Campaign Web](assets/full-email-2.png){zoomable="yes"}
...
1. Choisissez vos **[!UICONTROL Paramètres d’image]** :
   ...
   * **[!UICONTROL Composition]** : organisez les éléments dans le cadre de l’image.
   ...
   ![Capture d’écran affichant les options de paramètres d’image dans Adobe Campaign Web](assets/full-email-4.png){zoomable="yes"}
...
1. Naviguez vers l’option **[!UICONTROL Affiner]** dans la fenêtre **[!UICONTROL Aperçu]** pour accéder à d’autres fonctionnalités de personnalisation :
   ...
   * **[!UICONTROL Utiliser un langage plus simple]** : simplifiez votre langue pour garantir la clarté et l’accessibilité pour une audience plus large.
   ...
   ![Capture d’écran affichant les options d’affinement dans Adobe Campaign Web](assets/full-email-5.png){zoomable="yes"}
...
1. Insérez des champs de personnalisation pour personnaliser le contenu de votre e-mail en fonction des données de profil. Cliquez ensuite sur le bouton **[!UICONTROL Simuler du contenu]** pour contrôler le rendu et vérifier les paramètres de personnalisation avec les profils de test. [En savoir plus](../preview-test/preview-content.md)
   ...
   ![Capture d’écran affichant le bouton Simuler du contenu dans Adobe Campaign Web](assets/full-email-6.png){zoomable="yes"}
...
1. Sélectionnez un **[!UICONTROL composant de texte]** pour cibler un contenu spécifique, puis accédez au menu **[!UICONTROL Assistant IA]**.
   ...
   ![Capture d’écran affichant la sélection du composant de texte dans Adobe Campaign Web](assets/text-genai-1.png){zoomable="yes"}
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant la bibliothèque d’invites dans Adobe Campaign Web](assets/text-genai-2.png){zoomable="yes"}
...
1. Personnalisez l’invite à l’aide de l’option **[!UICONTROL Paramètres de texte]** :
   ...
   * **Longueur de texte** : utilisez le curseur pour sélectionner la longueur souhaitée de votre texte.
   ...
   ![Capture d’écran affichant les options de paramètres de texte dans Adobe Campaign Web](assets/text-genai-3.png){zoomable="yes"}
...
1. Naviguez vers l’option **[!UICONTROL Affiner]** dans la fenêtre **[!UICONTROL Aperçu]** pour accéder à d’autres fonctionnalités de personnalisation :
   ...
   * **[!UICONTROL Utiliser un langage plus simple]** : simplifiez votre langue pour garantir la clarté et l’accessibilité pour une audience plus large.
   ...
   ![Capture d’écran affichant les options d’affinement dans Adobe Campaign Web](assets/text-genai-4.png){zoomable="yes"}
...
1. Dans le menu de droite, sélectionnez **[!UICONTROL Assistant IA]**.
   ...
   ![Capture d’écran affichant le menu Assistant AI pour la génération d’images dans Adobe Campaign Web](assets/image-genai-1.png){zoomable="yes"}
...
1. Ajustez le contenu en décrivant ce que vous souhaitez générer dans le champ **[!UICONTROL Invite]**.
   ...
   ![Capture d’écran affichant la bibliothèque d’invites pour la génération d’images dans Adobe Campaign Web](assets/image-genai-2.png){zoomable="yes"}
...
1. Personnalisez l’invite à l’aide de l’option **[!UICONTROL Paramètres d’image]** :
   ...
   * **[!UICONTROL Composition]** : organisez les éléments dans le cadre de l’image.
   ...
   ![Capture d’écran affichant les options de paramètres d’image dans Adobe Campaign Web](assets/image-genai-3.png){zoomable="yes"}
...
1. Parcourez les **[!UICONTROL suggestions de variation]** pour trouver la ressource souhaitée.
   ...
   ![Capture d’écran affichant des suggestions de variation pour la génération d’images dans Adobe Campaign Web](assets/image-genai-5.png){zoomable="yes"}

1. Choisissez **[!UICONTROL Générer des résultats similaires]** si vous souhaitez afficher les images associées à cette variante.

   ![Capture d’écran affichant l’option de génération similaire dans Adobe Campaign Web](assets/image-genai-6.png){zoomable="yes"}
