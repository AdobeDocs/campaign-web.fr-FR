...
Le concepteur d’e-mail permet de définir facilement la structure de votre email. En ajoutant et en déplaçant des éléments structurels à l’aide de simples actions de glisser-déposer, vous concevez le corps de votre e-mail en quelques secondes.
...
1. Sur la page d’accueil du [concepteur d’e-mail](get-started-email-designer.md#start-authoring), cliquez sur l’option **[!UICONTROL Créer en partant de zéro]**.
   ...
   ![Capture d’écran affichant la page d’accueil de Designer par e-mail avec l’option « Créer en partant de zéro » mise en surbrillance.](assets/email_designer-from-scratch.png){zoomable="yes"}
...
1. Ajoutez autant de **[!UICONTROL Structures]** que nécessaire et modifiez leurs paramètres dans le volet dédié de droite.
   ...
   ![Capture d’écran affichant le volet Composants de structure dans le Designer d’e-mail.](assets/email_designer_structure_components.png){zoomable="yes"}

1. Sélectionnez le composant **[!UICONTROL n:n colonne]** pour définir le nombre de colonnes de votre choix (entre 3 et 10). Définissez la largeur de chaque colonne en déplaçant les flèches situées en bas de chacune d’elles.
...
1. Personnalisez chaque composant à l’aide des onglets **[!UICONTROL Paramètres]** ou **[!UICONTROL Style]** sur la droite. Par exemple, modifiez le style de texte, la marge intérieure ou la marge de chaque composant. [En savoir plus sur l’alignement et la marge intérieure](alignment-and-padding.md).

   ![Capture d’écran affichant les options de personnalisation du style dans le Designer Email.](assets/email_designer-styles.png){zoomable="yes"}
...
1. Ajouter des liens à votre contenu.
   ...
   Cliquez sur l’onglet **[!UICONTROL Liens]** dans le volet de gauche pour afficher toutes les URL du contenu qui seront trackées. Modifiez leur **[!UICONTROL Type de tracking]** ou **[!UICONTROL Libellé]**, puis ajoutez **[!UICONTROL Catégories]** si nécessaire.

[En savoir plus sur le tracking des liens et des messages.](message-tracking.md)

   ![Capture d’écran affichant l’onglet Liens dans le Designer Email.](assets/email_designer-links.png){zoomable="yes"}

1. Si nécessaire, personnalisez davantage votre e-mail en cliquant sur **[!UICONTROL Basculer vers l’éditeur de code]** dans le menu avancé. Vous pouvez ainsi modifier le code source de l’e-mail, par exemple pour ajouter des balises HTML de suivi ou personnalisées. [En savoir plus sur l’éditeur de code](code-content.md).

   >[!CAUTION]
   >
   >Vous ne pouvez pas revenir au concepteur visuel de cet e-mail après avoir basculé vers l’éditeur de code.

1. Une fois que votre contenu est prêt, cliquez sur **[!UICONTROL Simuler du contenu]** pour vérifier le rendu de l’e-mail. Choisissez la vue bureau ou mobile. [En savoir plus sur la prévisualisation des e-mails](../preview-test/preview-test.md).

   ![Capture d’écran affichant les options de simulation dans le Designer Email.](assets/email_designer-simulate.png){zoomable="yes"}

1. Lorsque votre e-mail est prêt, cliquez sur **[!UICONTROL Enregistrer]**.

## Vidéo pratique {#video}

Découvrez comment naviguer dans le concepteur d’e-mail. Découvrez comment structurer et concevoir entièrement un e-mail, le personnaliser et le tester.
