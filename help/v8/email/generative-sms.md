---
audience: end-user
title: SMS avec l’assistant d’IA dans Adobe Campaign Web pour l’accélération du contenu
...
# Génération de SMS avec l’assistant d’IA dans Adobe Campaign Web - Content Accelerator {#generative-sms}
