...
Lors de la création du contenu de votre e-mail, les composants **[!UICONTROL Content]** vous permettent de personnaliser votre e-mail à l’aide des composants bruts et vides que vous pouvez utiliser une fois placés dans un e-mail.
...
1. Faites glisser et déposez le **[!UICONTROL contenu]** de votre choix dans les structures appropriées.
   ...
   ![Capture d’écran montrant comment faire glisser et déposer des composants de contenu dans des structures dans le Designer d’e-mail.](assets/email_designer_add_content_components.png){zoomable="yes"}

   >[!NOTE]
   >
   >Vous pouvez ajouter plusieurs composants dans une seule structure et dans chaque colonne d’une structure.

1. Ajustez les options de chaque composant en utilisant l’onglet **[!UICONTROL Paramètres]** contextuels. Par exemple, choisissez de l’afficher uniquement sur les ordinateurs de bureau ou les appareils mobiles, ou les deux. Vous pouvez également gérer les options de lien à partir de cet onglet. [En savoir plus sur la gestion des liens](message-tracking.md)

1. Ajustez les attributs de style de chaque composant à l’aide de l’onglet **[!UICONTROL Style]**. Par exemple, modifiez le style de texte, la marge intérieure ou la marge de chaque composant. [En savoir plus sur l’alignement et la marge intérieure](alignment-and-padding.md).

   ![Capture d’écran affichant l’onglet Paramètres pour les composants de contenu dans le Designer d’e-mail.](assets/email_designer_content_components_settings.png){zoomable="yes"}

1. Dans le menu avancé de votre **[!UICONTROL Contenu]** dans le volet de droite, supprimez ou dupliquez n’importe quel composant de contenu, si nécessaire.
...
![Capture d’écran montrant comment ajouter un composant de conteneur dans le Designer d’e-mail.](assets/email_designer_container_component.png){zoomable="yes"}
...
1. À partir de la liste **[!UICONTROL Contenu]**, faites glisser et déposez le composant de **[!UICONTROL bouton]** dans un composant de **[!UICONTROL structure]**.
   ...
   ![Capture d’écran montrant comment faire glisser et déposer un composant Bouton dans le Designer d’e-mail.](assets/email_designer_13.png){zoomable="yes"}

1. Cliquez sur le bouton nouvellement ajouté pour personnaliser le texte et accéder aux onglets **[!UICONTROL Paramètres]** et **[!UICONTROL Styles]**.

   ![Capture d’écran affichant l’onglet Paramètres pour les composants de bouton dans le Designer d’e-mail.](assets/email_designer_14.png){zoomable="yes"}

1. Depuis l’onglet **[!UICONTROL Paramètres]** , dans le champ **[!UICONTROL URL]**, ajoutez l’URL vers laquelle rediriger lors d’un clic sur le bouton.

1. Choisissez le mode d’affichage du contenu à l’aide de la liste déroulante **[!UICONTROL Cible]** :
   ...
   * **[!UICONTROL Haut]** : ouvre le lien dans le corps complet de la fenêtre.
   ...
   ![Capture d’écran présentant les options cibles des composants Bouton dans le Designer d’e-mail.](assets/email_designer_15.png){zoomable="yes"}
...
1. Dans le menu **[!UICONTROL Contenu]**, faites glisser et déposez du **[!UICONTROL texte]** dans un composant de **[!UICONTROL structure]**.
   ...
   ![Capture d’écran montrant comment faire glisser et déposer un composant de texte dans le Designer d’e-mail.](assets/email_designer_11.png){zoomable="yes"}

1. Cliquez sur votre composant nouvellement ajouté pour personnaliser le texte et accéder aux onglets **[!UICONTROL Paramètres]** et **[!UICONTROL Styles]**.

1. Modifiez votre texte avec les options suivantes disponibles dans la barre d’outils contextuelle :

   ![Capture d’écran affichant la barre d’outils d’édition de texte dans le Designer Email.](assets/email_designer_27.png){zoomable="yes"}
   ...
   * **[!UICONTROL Créer une liste]** : ajoutez des listes à puces ou à nombres à votre texte.
...
1. Ajustez d’autres attributs de style, tels que la couleur du texte, la famille de polices, la bordure, la marge intérieure, la marge, etc., à partir de l’onglet **[!UICONTROL Styles]**.

   ![Capture d’écran affichant l’onglet styles pour les composants de texte dans le Designer d’e-mail.](assets/email_designer_12.png){zoomable="yes"}
...
![Capture d’écran montrant comment ajouter un composant diviseur dans le Designer d’e-mail.](assets/email_designer_16.png){zoomable="yes"}

## HTML {#HTML}

Utilisez le composant **[!UICONTROL HTML]** pour copier et coller des parties de votre HTML existant. Vous pouvez ainsi créer des composants modulaires HTML gratuits afin de réutiliser du contenu externe.

1. À partir des **[!UICONTROL Composants]**, faites glisser et déposez le composant **[!UICONTROL HTML]** dans une **[!UICONTROL structure]**.

   ![Capture d’écran montrant comment faire glisser et déposer un composant HTML dans le Designer d’e-mail.](assets/email_designer_22.png){zoomable="yes"}
...
1. Cliquez sur le composant que vous venez d’ajouter, puis sélectionnez **[!UICONTROL Afficher le code source]** dans la barre d’outils contextuelle pour ajouter votre code HTML.
   ...
   ![Capture d’écran montrant l’option de code source pour les composants HTML dans le Designer d’e-mail.](assets/email_designer_23.png){zoomable="yes"}

>[!NOTE]
>
>Pour rendre le contenu externe compatible avec Email Designer, Adobe recommande de [créer un message en partant de zéro](create-email-content.md) et de copier le contenu de l’e-mail existant dans des composants.
...
1. Dans le menu **[!UICONTROL Contenu]**, faites glisser et déposez **[!UICONTROL Image]** dans un composant **[!UICONTROL Structure]**.

   ![Capture d’écran montrant comment faire glisser et déposer un composant d’image dans le Designer d’e-mail.](assets/email_designer_9.png){zoomable="yes"}
...
1. Cliquez sur **[!UICONTROL Parcourir]** pour choisir un fichier image parmi vos ressources. Vous pouvez également choisir d’**[!UICONTROL importer votre contenu multimédia]**.
   ...
   Pour en savoir plus sur le chargement et l’ajout de ressources dans Adobe Experience Manager, consultez la [documentation Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html?lang=fr).

   ![Capture d’écran montrant l’option de navigation pour les composants d’image dans le Designer d’e-mail.](assets/email_designer_28.png){zoomable="yes"}
...
1. Parcourez vos dossiers pour localiser la ressource spécifique dont vous avez besoin ou utilisez la barre de recherche pour la chercher efficacement.
   ...
   ![Capture d’écran montrant le processus de sélection de ressources dans le Designer d’e-mail.](assets/email_designer_29.png){zoomable="yes"}
...
1. Cliquez sur le composant que vous venez d’ajouter et configurez les propriétés de l’image à l’aide de l’onglet **[!UICONTROL Paramètres]** :
   ...
   * **[!UICONTROL Texte alternatif]** permet de définir la légende associée à votre image. Cela correspond à l’attribut HTML alternatif.
   ...
   ![Capture d’écran affichant l’onglet Paramètres des composants d’image dans le Designer d’e-mail.](assets/email_designer_10.png){zoomable="yes"}

1. Ajoutez un lien pour rediriger votre audience vers un autre contenu. [En savoir plus](message-tracking.md)

1. Ajustez d’autres attributs de style, tels que la marge, la bordure et d’autres à l’aide de l’onglet **[!UICONTROL Styles]**.
...
1. Dans le champ **[!UICONTROL Social]** de l’onglet **[!UICONTROL Paramètres]**, sélectionnez les médias sociaux à ajouter ou à supprimer.
   ...
   ![Capture d’écran affichant l’onglet Paramètres des composants sociaux dans le Designer d’e-mail.](assets/email_designer_20.png){zoomable="yes"}
...
1. Cliquez sur chaque icône de réseau social pour configurer l’**[!UICONTROL URL]** vers laquelle votre audience est redirigée.
   ...
   ![Capture d’écran montrant la configuration de l’URL pour les icônes de réseaux sociaux dans le Designer d’e-mail.](assets/email_designer_21.png){zoomable="yes"}

1. Si nécessaire, modifiez les icônes de chacun de vos réseaux sociaux dans le champ **[!UICONTROL Source]**.
